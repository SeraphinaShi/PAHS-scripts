...
```{r gee_FuelTypes, fig.width=8, fig.height=3}
...
# 3.0. Clusters based on model-based exposure estimates (Current, Chioldhood, and Cumulative)
...
# 4.4. 5MC (Current, Childhood, Cumulative)
...
coefs <- rbind(plot_df_1, plot_df_2, plot_df_3)
coefs$exposure_time = factor(coefs$exposure_time, levels = c("Current Exposure","Childhood Exposure", "Cumulative Exposure"))
make_forest_plot_lg(coefs, "Expected EAA Change with 1 Unit Increased in 5MC Exposure") + 
  facet_wrap(~ exposure_time)
```
