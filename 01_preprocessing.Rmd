...
dat <- dat %>% 
  merge(clusCUR6, by=c("SbjctD","Visit"), all = T) %>% 
  merge(clusCHLD5, by=c("SbjctD","Visit"), all = T) %>% 
  merge(clusCUM6, by=c("SbjctD","Visit"), all = T) %>% 
  merge(clusMEAS6, by=c("SbjctD","Visit"), all = T) %>% 
  merge(clusURI5, by=c("SbjctD","Visit"), all = T) 
```
